    ...
    <main>
      ...
      {tab === 'game' ? (
        ...
        <section className="panel leaderboard">
          <div className="leader-head"><div><h2>🏆 Leaderboard</h2><p>Only verified on-chain game activity appears here.</p></div><div className="week">This Week</div></div>
          <div className="pool"><span>Weekly Prize Pool</span><b>50% of verified weekly deposits</b></div>
          <div className="empty-leaderboard">
            <div className="empty-icon">♟</div>
            <h3>No on-chain players yet</h3>
            <p>The leaderboard is intentionally empty. Players will appear only after the game records and verifies their chess activity on-chain.</p>
            <small>Wallet connections, sample names, and local browser activity do not create leaderboard entries.</small>
          </div>
          <p className="footnote">The current chess moves run in the browser. A production on-chain leaderboard still needs a backend or smart-contract/indexer flow to record verified games, wins, and weekly scores.</p>
        </section>
      )}
    </main>
  )
